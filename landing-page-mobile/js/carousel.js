class Carousel {
  constructor(carouselElement) {
    ...
    if (this.nextButton) {
      this.nextButton.addEventListener(
        "click",
        this.nextButtonClick.bind(this),
        false
      );
    }
  }
  ...
  init() {
    ...
    this.scrollLength =
      ...
      this.carouselElement.getBoundingClientRect().width;
  ...
  gotoNextSlide(fastSlide = false) {
    ...
    if (this.scrolledDistance + this.delta > this.scrollLength) {
      ...
      this.scrolledDistance = this.scrollLength;
      this.carouselContainer.style["transition-duration"] =
        remainingScroll / this.slideSpeed + "ms";
      this.direction = "left";
    } else {
      if (fastSlide) {
        this.carouselContainer.style["transition-duration"] =
          this.transitionDuration / 2 + "ms";
      } else {
        this.carouselContainer.style["transition-duration"] =
